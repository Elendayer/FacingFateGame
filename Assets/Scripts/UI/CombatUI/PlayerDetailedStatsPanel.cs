    ...
    public class PlayerDetailedStatsPanel : MonoBehaviour
    {
        ...
        private static readonly StatDef[] Definitions =
        {
            ...
            new("Strength",  s => $"{s.CurrentStrength:0}",
                "Strength",  "Physical power. Increases damage of Strength-scaling abilities.\nBase: 10."),
            new("Dexterity", s => $"{s.CurrentDexterity:0}",
                "Dexterity", "Agility and precision. Increases critical hit chance.\nBase: 10."),
            new("Wisdom",    s => $"{s.CurrentWisdom:0}",
                "Wisdom",    "Magical insight. Increases Wisdom-scaling ability power.\nBase: 10."),
            new("Foresight", s => $"{s.CurrentForesight:0}",
                "Foresight", "Perception and initiative. Influences draw order.\nBase: 10."),
            new("Endurance", s => $"{s.CurrentEndurance:0}",
                "Endurance", "Stamina reserve. Determines Max Stamina (Endurance × 5).\nBase: 10."),
            new("Tenacity",  s => $"{s.CurrentTenacity:0}",
                "Tenacity",  "Resilience. Determines Max Health (Tenacity × 50).\nBase: 10."),
