    ...
    public class NpcDatabase : MonoBehaviour
    {
        ...
        private static void RegisterNpcs()
        {
                ...
                cardIds = new List<string>()
            {
                ...
                "Assassin_Tech_Lotus_Death_Kiss",
                "Assassin_Tech_Moonlit_Needlestorm",
                "Assassin_Tech_Black_Lotus_Needle",
                //"Assassin_Tech_Moon_Piercing_Arrow",
                "Assassin_Tech_Midnight_Rain",
                "Assassin_Tech_Bouncing_Shot",
                "Assassin_Tech_Barbed_Needle_Volley",
                "Assassin_Tech_Merciful_Headshot",
                "Assassin_Tech_Crimson_Thorn_Array",
                "Assassin_Abil_Phantom_Step",
                "Assassin_Abil_Apply_Scorching_Blood_Venom",
                "Assassin_Abil_Apply_Black_Lotus_Venom",
                "Assassin_Abil_Apply_Dazzlying_Numbing_Venom",
                "Assassin_Abil_Reapply_Venom",
                "Assassin_Abil_Eye_of_the_Nighthawk",
                //"Assassin_Curse_Fumble",
                //"Assassin_Bless_Lucky_Strike",
            }
            });
            ...
            RegisterNpc(new NpcData()
            {
                ...
                cardIds = new List<string>()
            {
                "Physician_Tech_Jade_Needle_Acupuncture",
                "Physician_Tech_Bloodletting",
                "Physician_Tech_Formation_of_the_Hundred_Remedies",
                "Physician_Tech_Venomous_Grip",
                "Physician_Tech_Needle_of_the_Flowing_River",
                "Physician_Abil_Gather",
                "Physician_Abil_Toxic_Remedy_Paradox",
                "Physician_Abil_Poison_Barbs",
                "Physician_Abil_Doctors_Footwork",
                "Physician_Spell_Jade_Needle_Resonance",
                "Physician_Spell_Breath_of_the_Jade_Lotus",
                ...
                "Physician_Item_Crystal_Cleansing_Balm",
                "Physician_Item_Mandrake_Poison_Cloud",
                //"Physician_Curse_Alchemists_Misstep",
                //"Physician_Item_Mythical_Herb",
            }
            });
            ...
            RegisterNpc(new NpcData()
            {
                ...
                cardIds = new List<string>()
                {
                    ...
                    "Assassin_Tech_Shadowfang_Strike",
                    "Assassin_Tech_Shadowfang_Strike",
                    "Assassin_Tech_Dance_of_Hundred_Cuts",
                    "Assassin_Tech_Dance_of_Hundred_Cuts",
                    "Assassin_Abil_Apply_Scorching_Blood_Venom",
                    "Assassin_Abil_Apply_Black_Lotus_Venom",
                    "Assassin_Tech_Bouncing_Shot",
